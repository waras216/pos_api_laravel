 ...
 Route::middleware(['sesion.inactiva', 'auth:sanctum'])->group(function(){
    ...
    Route::middleware(['tenant.activo', 'usuario.activo'])->group(function () {
        ...
        Route::prefix('erp')->middleware('modulo:erp')->group(function () {
            ...
            Route::get('mesas/pendientes', [MesaController::class, 'pendientes'])->middleware('permiso:erp_ventas.comandas');
            ...
            Route::patch('mesas/{id}/preparada', [MesaController::class, 'marcarPreparada'])->middleware('permiso:erp_ventas.comandas');
            Route::patch('mesas/{id}/entregada', [MesaController::class, 'marcarEntregada'])->middleware('permiso:erp_ventas.editar');
            ...
            Route::get('habitaciones/huespedes/{idCliente}/historial', [HabitacionController::class, 'historialCliente'])->middleware('permiso:erp_ventas.ver');
            Route::get('habitaciones/disponibilidad', [HabitacionController::class, 'disponibilidad'])->middleware('permiso:erp_ventas.ver');
            Route::get('habitaciones/reportes/ocupacion', [HabitacionController::class, 'reporteOcupacion'])->middleware('permiso:erp_ventas.ver');
            Route::get('tarifas-temporada', [TarifaTemporadaController::class, 'index'])->middleware('permiso:erp_ventas.ver');
            Route::post('tarifas-temporada', [TarifaTemporadaController::class, 'store'])->middleware('permiso:erp_ventas.editar');
            Route::patch('tarifas-temporada/{id}', [TarifaTemporadaController::class, 'update'])->middleware('permiso:erp_ventas.editar');
            Route::delete('tarifas-temporada/{id}', [TarifaTemporadaController::class, 'destroy'])->middleware('permiso:erp_ventas.editar');
            ...
            Route::get('habitaciones/{id}/estimado', [HabitacionController::class, 'estimadoHospedaje'])->middleware('permiso:erp_ventas.ver');
            Route::post('habitaciones/{id}/registro', [HabitacionController::class, 'registrarDocumento'])->middleware('permiso:erp_ventas.editar');
