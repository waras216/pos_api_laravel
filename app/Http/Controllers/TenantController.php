...
class TenantController extends Controller
{
    ...
    public function completeOnboarding(Request $request)
    {
        $data = $request->validate([
            ...
            'datos_nicho.hotelTipo' => 'nullable|string|max:60',
            ...
            'datos_nicho.hotelAmenidades' => 'nullable|array',
            'datos_nicho.hotelAmenidades.*' => 'string|max:40',
            'datos_nicho.restTipo' => 'nullable|string|max:60',
            'datos_nicho.restMesas' => 'nullable|integer|min:1|max:200',
            'datos_nicho.restCanales' => 'nullable|array',
            'datos_nicho.restCanales.*' => 'string|max:40',
            'datos_nicho.almacenTipo' => 'nullable|string|max:60',
            'datos_nicho.almacenSkus' => 'nullable|string|max:60',
            'datos_nicho.almacenOps' => 'nullable|array',
            'datos_nicho.almacenOps.*' => 'string|max:40',
            'datos_nicho.farmTipo' => 'nullable|string|max:60',
            'datos_nicho.farmAtencion' => 'nullable|array',
            'datos_nicho.farmAtencion.*' => 'string|max:40',
            'datos_nicho.farmEspecialidades' => 'nullable|array',
            'datos_nicho.farmEspecialidades.*' => 'string|max:40',
            'datos_nicho.startupEtapa' => 'nullable|string|max:60',
            'datos_nicho.startupModelo' => 'nullable|string|max:60',
            'datos_nicho.startupMetricas' => 'nullable|array',
            'datos_nicho.startupMetricas.*' => 'string|max:40',
            'datos_nicho.tiendaTipo' => 'nullable|string|max:60',
            'datos_nicho.tiendaCanales' => 'nullable|array',
            'datos_nicho.tiendaCanales.*' => 'string|max:40',
